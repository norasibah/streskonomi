  ...
  const OVERALL_RECOMMENDATIONS = {
    "Sangat Rendah": {
      ...
      actions: [
        ...
        "Pantau perubahan kos dalam keadaan semasa dan bertindakbalas dengan sewajarnya.",
      ],
    },
    Rendah: {
      icon: "🟦",
    ...
    Tinggi: {
      ...
      actions: [
        ...
        "Henti berbelanja ikut gaya hidup, utamakan keperluan hidup.",
        "Jika perlu, struktur semula hutang (contoh: re-financing)",
        "Amalkan pengurusan stres; lakukan pengukuhan sokongan sosial.",
    ...
    "Sangat Tinggi": {
      ...
      actions: [
        ...
        "Struktur semula hutang jika perlu.",
        "Mengamalkan kaedah Bajet dari kosong (Zero-Based Budget (ZBB)) - satu kaedah bajet di mana setiap ringgit mesti ada tujuan yang jelas, sama ada untuk belanja, simpan, hutang atau pelaburan.",
